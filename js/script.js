...
/*
	...
	toolKit = {
		addMarker : function(marker, markerHTML, openPopup, fav) {
			...
			markerHTML2 += ' data-latlng="' + latlng + '" style="float: left;"></div><div class="marker-popup-content">' + markerHTML + '</div><div><a class="setDestination" data-latlng="' + latlng + '">Navigate to hello22</a></div>';
